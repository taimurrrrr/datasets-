...
msra_root_dir = './data/MSRA_TD500/'
msra_train_data_dir = msra_root_dir + 'train/img/'
msra_train_gt_dir = msra_root_dir + 'train/gt/'
msra_test_data_dir = msra_root_dir + 'test/img/'
msra_test_gt_dir = msra_root_dir + 'test/gt/'

hust_root_dir = './data/HUST_TR400/'
hust_train_data_dir = hust_root_dir+'img/'
hust_train_gt_dir = hust_root_dir+'gt/'
...
class PSENET_MSRA(data.Dataset):
    def __init__(self,
                 split='train',
                 is_transform=False,
                 img_size=None,
    ...
    def prepare_train_data(self, index):
        ...
        for i in range(1, self.kernel_num+1):
            # 璁烘枃涓彁鍒版槸绾挎€у鍔犲埌1
            rate = 1.0 - (1.0 - self.min_scale) / (self.kernel_num - 1) * i  # 灏哄害姣斾緥
